<template>
  <div id="app" class="app">
    ...
    <main
      class="main-content"
      v-bkloading="{ loading: mainContentLoading, opacity: 1 }"
    >
  ...
  created() {
    ...
    if (platform.indexOf('win') === 0) {
      document.body.style['font-family'] =
        'Microsoft Yahei, PingFang SC, Helvetica, Aria'
    } else {
      document.body.style['font-family'] =
        'PingFang SC, Microsoft Yahei, Helvetica, Aria'
    }
  },
  mounted() {
    ...
    $on(window.bus, 'show-permission-modal', (data) => {
