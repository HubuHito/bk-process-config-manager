...
const ProcessManage = () =>
  import(/* webpackChunkName: 'ProcessManage' */ '@/views/ProcessManage').catch(
    () => window.showDeployTip()
  )
const ProcessManageStatus = () =>
  import(
    /* webpackChunkName: 'ProcessManageStatus' */ '@/views/ProcessManage/Status'
  ).catch(() => window.showDeployTip())
const ProcessManageReleaseConfig = () =>
  import(
    /* webpackChunkName: 'ProcessManageReleaseConfig' */ '@/views/ProcessManage/ReleaseConfig'
  ).catch(() => window.showDeployTip())

const ProcessAttribute = () =>
  import(
    /* webpackChunkName: 'ProcessAttribute' */ '@/views/ProcessAttribute'
  ).catch(() => window.showDeployTip())

const ConfigFile = () =>
  import(/* webpackChunkName: 'ConfigFile' */ '@/views/ConfigFile').catch(() =>
    window.showDeployTip()
  )
const ConfigFileTemplate = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplate' */ '@/views/ConfigFile/Template'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateList = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateList' */ '@/views/ConfigFile/Template/List'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateVersion = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateVersion' */ '@/views/ConfigFile/Template/Version'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateVersionList = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateVersion' */ '@/views/ConfigFile/Template/Version/List'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateVersionDetail = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateVersion' */ '@/views/ConfigFile/Template/Version/Detail'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateDistribute = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateDistribute' */ '@/views/ConfigFile/Template/Distribute'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateGenerate = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateGenerate' */ '@/views/ConfigFile/Template/Generate'
  ).catch(() => window.showDeployTip())
const ConfigFileTemplateCheck = () =>
  import(
    /* webpackChunkName: 'ConfigFileTemplateCheck' */ '@/views/ConfigFile/Template/Check'
  ).catch(() => window.showDeployTip())

const TaskHistory = () =>
  import(/* webpackChunkName: 'TaskHistory' */ '@/views/TaskHistory').catch(
    () => window.showDeployTip()
  )
const TaskHistoryList = () =>
  import(
    /* webpackChunkName: 'TaskHistoryList' */ '@/views/TaskHistory/List'
  ).catch(() => window.showDeployTip())
const TaskHistoryDetail = () =>
  import(
    /* webpackChunkName: 'TaskHistoryDetail' */ '@/views/TaskHistory/Detail'
  ).catch(() => window.showDeployTip())

const Statistics = () =>
  import(/* webpackChunkName: 'Statistics' */ '@/views/Statistics').catch(() =>
    window.showDeployTip()
  )

const NotFound = () =>
  import(/* webpackChunkName: 'none' */ '@/views/NotFound').catch(() =>
    window.showDeployTip()
  )
...
const router = VueRouter.createRouter({
  history: VueRouter.createWebHistory(window.PROJECT_CONFIG.SITE_URL),
  routes,
})
...
router.beforeEach(async (to, from, next) => {
  ...
  if (!to.query.biz && store.state.bizId) {
    ...
    let replace = false
    const replaceNames = [
      'config-file-template-version-detail',
      'config-file-template-version-preview',
    ]
