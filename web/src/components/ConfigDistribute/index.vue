<template>
  <div
    class="config-file-template-distribute-container"
    v-test.release="'release'"
    v-bkloading="{ loading: fakeLoading }"
  >
    <div class="distribute-above">
      ...
      <div class="form-container" v-if="curStep === 1 && isMultipleTemplates">
        ...
        >
          <template
            v-for="option in validTemplates"
            :key="option.config_template_id"
          >
            <bk-option
              :value="option.config_template_id"
    ...
    <div
      class="distribute-below"
      v-bkloading="{ loading: basicLoading, opacity: 1, zIndex: 0 }"
    >
      <!-- 实例表格 -->
      <div class="instance-table-container">
        <template
          v-for="temp in selectedTemplates"
        ...
        <template v-else>
          ...
          <div
            ...
            v-bk-tooltips="{
              ...
              disabled: isAllGeneratedSuccess,
            }"
          >
            <bk-button
              theme="primary"
