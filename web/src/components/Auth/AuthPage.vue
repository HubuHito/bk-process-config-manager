      ...
      <div class="operate-list">
        ...
        <div class="operate-item">
          ...
          <div class="operate-center">
            <img
              class="not-biz-image"
              src="../../assets/images/empty-not-biz.png"
              alt=""
            />
          </div>
          <div class="operate-bottom">
            <bk-button
              class="operate-btn reset-icon-btn"
              theme="primary"
              @click="handleClick('newBiz')"
            >
              <span class="flex-content">
                {{ $t('创建新业务')
                }}<span class="ml6 gsekit-icon gsekit-icon-jump-fill"></span>
              </span>
            </bk-button>
          </div>
        </div>
