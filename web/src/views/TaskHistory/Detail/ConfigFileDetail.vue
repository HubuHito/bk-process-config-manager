<template>
  <div class="detail-list">
    <ul class="row">
      <li class="couple">
        <label>{{ $t('模板ID') }}</label>
        <span>{{ configFileDetail.config_template_id || '--' }}</span>
      </li>
      <li class="couple">
        <label>{{ $t('模板名称') }}</label>
        <span v-bk-overflow-tips>{{
          configFileDetail.template_name || '--'
        }}</span>
      </li>
      <li class="couple">
        <label>{{ $t('文件名称') }}</label>
      ...
      <li class="couple">
        <label>{{ $t('文件拥有者') }}</label>
        <span>{{ configFileDetail.owner || '--' }}</span>
      </li>
      <li class="couple">
        <label>{{ $t('文件用户组') }}</label>
        <span>{{ configFileDetail.group || '--' }}</span>
      </li>
      <li class="couple">
        <label>{{ $t('文件权限') }}</label>
      ...
      <li class="couple">
        <label>{{ $t('输出格式') }}</label>
        <span>{{
          fileFormatMap[configFileDetail.line_separator] || '--'
        }}</span>
      </li>
    </ul>
  </div>
