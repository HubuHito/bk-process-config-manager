      ...
      >
        ...
        >
          <bk-tag-input
            ...
            :list="propList"
            :placeholder="$t('请选择')"
            v-model:value="propForm.selected"
          >
          </bk-tag-input>
        </bk-form-item>
        <bk-form-item
        ...
        >
          <div class="form-prop-item">
            <bk-input v-model:value="propForm[prop]"></bk-input>
            <i
              class="delete-icon ml10 gsekit-icon gsekit-icon-close-line"
