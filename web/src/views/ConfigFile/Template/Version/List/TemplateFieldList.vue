    ...
    <div class="row">
      ...
      <div class="couple">
        <div class="field-content">
          ...
          <span
            v-if="selectedConfig.relation_count"
            class="field-value button-text"
            @click="showBindProcess = true"
          >
            {{
              selectedConfig.relation_count.TEMPLATE +
              selectedConfig.relation_count.INSTANCE
            }}
          </span>
        </div>
      </div>
...
export default {
  ...
  methods: {
    handleBindSuccess(templateCount, instanceCount) {
      $emit(this, 'change', {
        key: 'relation_count',
        value: { TEMPLATE: templateCount, INSTANCE: instanceCount },
      })
      $emit(this, 'change', {
        key: 'is_bound',
        value: !!templateCount || !!instanceCount,
      })
    },
  },
  emits: ['change'],
