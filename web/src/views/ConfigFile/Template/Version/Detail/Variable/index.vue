<template>
  <div class="variable-panel-container" v-test="'variable'">
    ...
    <div class="right-panel-main">
      ...
      />
      <div
        v-bkloading="{ loading: searchLoading, opacity: 0.1 }"
      ...
      >
        ...
        <div v-show="activeTab === 'global'" class="table-container">
          ...
          <ul class="table-body">
            <template v-for="item in globalVariables" :key="item.key">
              <li
                v-show="item.isShow"
              ...
              >
                <div class="copy-text-container" :data-copy-text="item.key">
                  <span class="text-overflow-row couple-left">{{
                    item.name
                  }}</span>
                  <span class="text-overflow-row couple-right">{{
                    item.key
                  }}</span>
                </div>
              </li>
...
export default {
  ...
  methods: {
      ...
      this.inputTimer = setTimeout(
        () => {
          ...
          this.globalVariables.forEach((item) => {
            ...
            item.isShow = variableKeyAndName
              .toLowerCase()
    ...
    findCopyElement(e) {
      ...
      while (
        el !== null &&
        !el.classList.value.includes('copy-text-container')
      ) {
        el = el.parentElement
      }
      return el
